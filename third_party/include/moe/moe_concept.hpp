...
#define CUTABLE_DEFAULT_IMPLEMENT \
	{ return std::make_unique<std::remove_reference<decltype(*this)>::type>(std::move(*this)); }
#define CLONEABLE_DEFAULT_IMPLEMENT \
	{ return std::make_unique<std::remove_const<std::remove_reference<decltype(*this)>::type>::type>(*this); }
